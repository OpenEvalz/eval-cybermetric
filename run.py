#!/usr/bin/env python3
"""Run ONE problem of cybermetric through TrustedRouter and emit a reproducibility bundle.
...
TASK = "inspect_evals/cybermetric_80"
...
def main() -> int:
    ap = argparse.ArgumentParser(description="Run one cybermetric problem via TrustedRouter")
